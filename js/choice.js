 (function (root, factory) {
     if (typeof define === 'function' && define.amd) {
         ...
         root.choice = factory(root.jQuery);
     }
...
(function() {
    return function(v, j, g) {
        ...
        function n(c, a, e) {
            ...
            if (typeof a === 'object') {
                return c.each(function() {
                    ...
                    new choice.classes[a.component || 'Scroller'](this, a);
                });
            }
            if (typeof a === 'string') {
                c.each(function() {
        ...
        var d, i, e, a = typeof jQuery == 'undefined' ? choice.$ : jQuery,
            r = +new Date(),
            b = {},
            c = a.extend,
        ...
        a.choice = choice;
        a.fn.choice = function(a) {
            c(this, choice.components);
            return n(this, a, arguments);
        };
        choice.classes.Base = function(i, e) {
            var m, j, f, o, g, l, h = choice,
                n = h.util,
                k = n.getCoord,
                d = this;
            d.settings = {};
...
(function() {
    choice.i18n['en-GB'] = choice.i18n['en-UK'] = {
        dateFormat: 'dd-mm-yy',
        timeFormat: 'HH:ii'
    };
}());
...
(function() {
    choice.i18n['ru-RU'] = choice.i18n.ru = {
        setText: 'Установить',
        cancelText: 'Отмена',
        clearText: 'Очистить',
...
(function() {
    choice.themes.frame['android-holo'] = {
        dateDisplay: 'Mddyy',
        rows: 5,
        minWidth: 76,
        height: 36,
...
(function(n, m, b) {
    ...
    f.Scroller = function(y, X, a7) {
        ...
        g._detachEvents = function(b) {
            a('.mbsc-sc-whl', b).choice('destroy');
        };
...
(function() {
    choice.$.each(['date', 'time', 'datetime'], function(b, a) {
        choice.presetShort(a);
    });
}());
(function(a) {
    var c = choice,
    ...
    b.classes.Form = function(q, r) {
        ...
        j.refresh = function(g) {
            a('input,select,textarea,progress,button', i).each(function() {
                ...
                if (k.attr('data-enhance') != 'false' && choice.vKMaI) {
        ...
        j.destroy = function() {
            ...
            j._destroy();
            a('.mbsc-progress progress', i).choice('destroy');
            a('.mbsc-slider input', i).choice('destroy');
            a('.mbsc-stepper input', i).choice('destroy');
            a('.mbsc-switch input', i).choice('destroy');
        };
        d = j.settings;
        m = j.trigger;
        j.init(r);
    ...
    a(function() {
        ...
        a(document).on('mbsc-enhance', function(b, c) {
            if (a(b.target).is('[mbsc-enhance]')) {
                a(b.target).choice().form(c);
            } else {
                a('[mbsc-enhance]', b.target).each(function() {
                    a(this).choice().form(c);
                });
            }
        });
        a(document).on('mbsc-refresh', function(b) {
            if (a(b.target).is('[mbsc-enhance]')) {
                a(b.target).choice('refresh');
            } else {
                a('[mbsc-enhance]', b.target).each(function() {
                    a(this).choice('refresh');
                });
            }
        });
    });
...
(function() {
    choice.themes.form['android-holo'] = {};
}());
(function() {
    choice.themes.form.ios = {};
}());
(function() {
    var a = choice.$;
    choice.themes.form.material = {
        onControlActivate: function(d) {
            ...
            if (c) {
                choice.themes.material.addRipple(c, d.domEvent);
            }
        },
        onControlDeactivate: function() {
            choice.themes.material.removeRipple();
        }
    };
}());
(function() {
    choice.themes.form.wp = {};
}());
(function() {
    var b = choice,
        a = b.$;
...
(function(n, h, f) {
    ...
    k.ListView = function(bB, bH) {
        ...
        function bP(c) {
            ...
            if (q(c, this) && !R && !X && !e && !aN && choice.vKMaI) {
                R = true;
                aM = true;
                ax = b(c, 'X');
                au = b(c, 'Y');
...
(function() {
    choice.themes.listview.ios = {
        leftArrowClass: 'mbsc-ic-ion-ios7-arrow-back',
        rightArrowClass: 'mbsc-ic-ion-ios7-arrow-forward'
    };
}());
(function() {
    choice.themes.listview.jqm = {
...
(function() {
    choice.themes.menustrip['android-holo'] = {};
}());
(function() {
    choice.themes.menustrip.bootstrap = {
...
(function() {
    choice.themes.menustrip.ios = {};
}());
(function() {
    var a = choice.$,
        b = a.mobile && a.mobile.version && a.mobile.version.match(/1\.4/);
    choice.themes.menustrip.jqm = {
        activeClass: 'ui-btn-active',
...
(function() {
    var a = choice.$;
    choice.themes.menustrip.material = {
        onInit: function() {
            choice.themes.material.initRipple(a(this), '.mbsc-ms-item', 'mbsc-btn-d', 'mbsc-btn-nhl');
        },
...
(function(d) {
    ...
    c.Widget = function(h, i, k) {
        function j(b) {
            a('.mbsc-fr-c', b);
            if (!a('.mbsc-fr-c', b).hasClass('mbsc-wdg-c') && choice.vKMaI) {
...
(function() {
    ...
    choice.themes.listview['ios-dark'] = {
        baseTheme: 'ios'
    };
    choice.themes.menustrip['ios-dark'] = {
        baseTheme: 'ios'
    };
    choice.themes.form['ios-dark'] = {
        baseTheme: 'ios'
    };
    choice.themes.progress['ios-dark'] = {
        baseTheme: 'ios'
    };
}());
(function() {
    var a = choice.$;
    choice.themes.frame['material-dark'] = {
        baseTheme: 'material',
        showLabel: false,
        headerText: false,
        btnWidth: false,
        ...
        btnCalNextClass: 'mbsc-ic mbsc-ic-material-keyboard-arrow-right',
        onMarkupReady: function(b) {
            choice.themes.material.initRipple(a(b.target), '.mbsc-fr-btn-e', 'mbsc-fr-btn-d', 'mbsc-fr-btn-nhl');
        },
        onEventBubbleShow: function(e) {
            var b = a(e.eventList),
                c = a(e.target).closest('.mbsc-cal-row').index() < 2,
    ...
    choice.themes.listview['material-dark'] = {
        baseTheme: 'material',
        onItemActivate: function(b) {
            choice.themes.material.addRipple(a(b.target), b.domEvent);
        },
        onItemDeactivate: function() {
            choice.themes.material.removeRipple();
        },
    ...
    choice.themes.menustrip['material-dark'] = {
        baseTheme: 'material',
        onInit: function() {
            choice.themes.material.initRipple(a(this), '.mbsc-ms-item', 'mbsc-btn-d', 'mbsc-btn-nhl');
        }
    };
    choice.themes.form['material-dark'] = {
        baseTheme: 'material',
        onControlActivate: function(d) {
            var c, b = a(d.target);
            if (b[0].type == 'button' || b[0].type == 'submit') {
    ...
    choice.themes.progress['material-dark'] = {
        baseTheme: 'material'
    };
}());
(function() {
    choice.themes.frame['android-holo-light'] = {
    ...
    choice.themes.listview['android-holo-light'] = {
        baseTheme: 'android-holo'
    };
    choice.themes.menustrip['android-holo-light'] = {
        baseTheme: 'android-holo'
    };
    choice.themes.form['android-holo-light'] = {
        baseTheme: 'android-holo'
    };
    choice.themes.progress['android-holo-light'] = {
        baseTheme: 'android-holo'
    };
}());
(function() {
    var a = choice.$;
    choice.themes.frame['wp-light'] = {
        baseTheme: 'wp',
        minWidth: 76,
        height: 76,
        dateDisplay: 'mmMMddDDyy',
    ...
    choice.themes.listview['wp-light'] = {
        baseTheme: 'wp'
    };
    choice.themes.menustrip['wp-light'] = {
        baseTheme: 'wp'
    };
    choice.themes.form['wp-light'] = {
        baseTheme: 'wp'
    };
    choice.themes.progress['wp-light'] = {
        baseTheme: 'wp'
    };
}());
(function() {
    choice.themes.frame['choice-dark'] = {
        baseTheme: 'choice',
        rows: 5,
        showLabel: false,
        headerText: false,
    ...
    choice.themes.listview['choice-dark'] = {
        baseTheme: 'choice'
    };
    choice.themes.menustrip['choice-dark'] = {
        baseTheme: 'choice'
    };
    choice.themes.form['choice-dark'] = {
        baseTheme: 'choice'
    };
    choice.themes.progress['choice-dark'] = {
        baseTheme: 'choice'
    };
}());
(function() {
