 ...
 console.log(options)
  ...
  Calendar.prototype = {
    showHoverInfo: function (obj) { // hover 时显示当天信息
      ...
      var offset_t = ($(obj).offset().top + (this.$calendar_today.height() - $(obj).height()) / 2)-78;
      var offset_l = ($(obj).offset().left + $(obj).width())-15;
...
console.log(offset_t)
    ...
    renderDOM: function () { // 渲染DOM
      ...
      var _titleStr = '<a href="#" class="title"></a>'+
                        '<span class="arrow-prev fa fa-chevron-left"></span>'+
                        '<span class="arrow-next fa fa-chevron-right"></span>';
                      // '</div>';
