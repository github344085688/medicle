(function(root, factory) {
   ...
   var datadd
    var defaults = {
            ...
            data: null,
            label: '{d}\n{v}',
            prev: '<img src="imgs/arrow_prev.png">',
            next: '<img src="imgs/arrow_next.png">',
            viewChange: $.noop,
        ...
        TEMPLATE = [
            ...
            '<div class="calendar-hd">',
            '<span data-calendar-display-month class="calendar-display">{yyyy}</span>',
            '<div class="calendar-arrow">',
    ...
    Date.getSiblingsMonth = function(y, m, n) {
        ...
        var td=PrefixInteger(d.getMonth() + 1,2);
    ...
    Calendar.prototype = {
        ...
        getDayData: function(day) {
           ...
           // console.log(this.data);
            //console.log(app.calendarsta);
           // console.log("optionsappta");
        ...
        getDaybfclor: function(day) {
            var bgcol, data = datadd;
           /* console.log("calendarsta");
            console.log(app.calendarsta);*/
            if (data) {
                for (var i = 0, len = data.length; i < len; i++) {
                    var item = data[i];
        ...
        getDayItem: function(y, m, d, f) {
            ...
            if (markData) {
                ...
                $item.html(d + '<i class="dot" style="background-color: '+this.getDaybfclor(idt)+'"></i>');
            ...
            var _this = this,
                ...
                exec = {
                    prev: function() {
                        ...
                        _this.options.ongetMonth.call(this, pm);
                        m = pm.m;
                        y = pm.y;
                        $dis.animate({
                            marginLeft: 0
                    ...
                    next: function() {
                        ...
                        var tadystamp = Date.parse(new Date(year,month+1));
                        var timestamp = Date.parse(new Date(y,m));
                        if(timestamp<tadystamp){
                            var nm = Date.getNextMonth(y, m),
                                nnm = Date.getNextMonth(y, m, 2),
                                $nextItem = _this.getDaysHtml(nnm.y, nnm.m);
                            _this.options.ongetMonth.call(this, nm);
                            m = nm.m;
                            y = nm.y;
                            $dis.animate({
                                marginLeft: '-200%'
        ...
        event: function() {
            ...
            _this.$element.on('click', '[' + ITEM_DAY + ']', function() {
                ...
                vc('date', y, m);
                _this.options.onSelected.call(this, 'month', day, new Date(y, m - 1));
            });
